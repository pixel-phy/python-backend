...
cola = deque()
enviadas = 0
contador_tipos = {"email": 0, "push": 0, "sms": 0}
...
while True:
    ...
    if opcion == "1":
        ...
        for usuario, mensaje, tipo in enviar_hoy:
            ...
            tiempo_total += 2  # 2 segundos por notificación
            enviadas += 1
            contador_tipos[tipo] += 1
        
        print(f"Tiempo estimado: {tiempo_total} segundos")
